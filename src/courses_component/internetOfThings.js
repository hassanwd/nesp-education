      ...
      <div className="container w-75">
        <div className="row">
          ...
          <div className="courses_column_2 col-md-4 col-sm-12 col-12">
            <img src={Image} alt="" />
            <a href="https://docs.google.com/forms/d/e/1FAIpQLScCzz1lTmcCk62UgKPOutED_M3VE5vIgSLOkXvxqgGr7Gvd5A/viewform?usp=sf_link" target=" _blank "><button>Apply Now</button></a>
          </div>
        </div>
      </div>
