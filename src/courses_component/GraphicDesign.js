    ...
    return(
      <>
        ...
        <div className='container w-75'>
          ...
          <p className='mt-4'>Designing has been one of the great career nowadays. Earlier career in designing field was not having much scope. But with the introduction of new career opportunities in various field and at the same time it has given a rise in the fields of Designing too. There has been several designing fields that emerged with the time like viz. Interior Designer, Jewelry Designer, Landscape Designers, Graphic Designers, Product Designers etc. Technology has advanced so much that the world is in the hand of the people through internet. A rapid use of internet has given a room for the Graphic Designer which has led to the huge requirement of the Graphic Designer students. Students who have a great imagination power and creativity and who loves to work on the computers for long hours can make a great career in the field of Graphic Designing.</p>
        </div>
        <div className='container w-75 mt-5'>
          <h1 className=' python_heading'>Job Market of Graphic Designing</h1>
          <p className='mt-4'>A degree relating to graphic design can be beneficial for a range of careers. The best job for you depends on your interests, skills, career goals and values. Estimated salary figure (40,000Rs to 80,000Rs)  Here are 11 graphic design-related jobs to explore as you begin your job search. Photo editor, Apparel graphic designer, Logo designer, Packaging designer, Web designer, Multimedia designer, Advertising designer, Publication designer, Art director, User interface (UI) designer, User experience (UX) designer</p>
        </div>
